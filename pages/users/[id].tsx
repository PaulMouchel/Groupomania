...
const User: NextPage = () => {
    ...
    return (
        <div className={styles.container}>
            ...
            { isCurrentUser && modalOpen && <EditProfileModal user={currentUser} closeModal={() => setModalOpen(false)}/> }
                ...
                <div className={styles.main__content}>
                    ...
                    { user && 
                        <>
                            ...
                            { isCurrentUser && <Button variant="contained" onClick={() => setModalOpen(true)} >Modifier les informations</Button> }
